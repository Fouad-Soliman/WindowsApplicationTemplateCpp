...
void User::displaydata()
{
    ...
    if(FPLSys::AllUsersTeams.find(id)!= FPLSys::AllUsersTeams.end())
        cout<<"Current Gameweek Points: " << FPLSys::AllUsersTeams[id]->calculateSquadPoints() << endl;
...
{
    totalPoints += FPLSys::AllUsersTeams[id]->calculateSquadPoints();
}
